...
INSERT INTO `ht9`.`products` (`title`, `cost`, `created_at`, `updated_at`) VALUES
('one', '110', now(), now()),
('two', '220', now(), now()),
('three', '330', now(), now()),
('four', '440', now(), now()),
...
CREATE TABLE `ht9`.`categories` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`));

INSERT INTO `ht9`.`categories` (`name`) VALUES
('cat_1'),
('cat_2'),
('cat_3'),
('cat_4'),
...
CREATE TABLE `ht9`.`products_categories` (
