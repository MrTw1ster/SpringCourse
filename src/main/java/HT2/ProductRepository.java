...
public class ProductRepository {
    ...
    public void init() {
        ...
        products.add(new Product(1, "AI-100", 110));
        products.add(new Product(2, "AI-95", 100));
        products.add(new Product(3, "AI-92", 90));
        products.add(new Product(4, "AI-80", 75));
        products.add(new Product(5, "Diesel", 95));
    }
